...
% "Ts": período de muestreo sobre "xc" para obtener la señal de salida "xd" que a su 
% vez tendrá como vector de muestras de tiempo "tsamp"

% Cálculo del intervalo de tiempo entre la primera y la última muestra de "xc":
T = t(end) - t(1);
